  ...
  return (
    <section id="tools" className={layout.section}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <img onClick={() => window.location.href = 'https://play.google.com/store/apps/details?id=com.sharad.NseIndicesOptionVirtualTrading'} src={play_store_logo} alt="Play store" />
      </div>
    </section>
  );
};
